...
export const BulletPointsIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const DragHandleIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 shrink-0" viewBox="0 0 20 20" fill="currentColor">
        <path d="M5 3a1 1 0 000 2h1a1 1 0 100-2H5zM5 7a1 1 0 000 2h1a1 1 0 100-2H5zM5 11a1 1 0 000 2h1a1 1 0 100-2H5zM9 3a1 1 0 000 2h1a1 1 0 100-2H9zM9 7a1 1 0 000 2h1a1 1 0 100-2H9zM9 11a1 1 0 000 2h1a1 1 0 100-2H9zM13 3a1 1 0 000 2h1a1 1 0 100-2h-1zM13 7a1 1 0 000 2h1a1 1 0 100-2h-1zM13 11a1 1 0 000 2h1a1 1 0 100-2h-1z" />
    </svg>
);
